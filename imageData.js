...
imageData.prototype.GetImageDataAlphaAt = function(h,w)
{
   return this.imgDataObj.data[this.Make1dIndex(h,w,3)];
};
imageData.prototype.SetImageDataAlphaAt = function(h,w,value)
{
   this.imgDataObj.data[this.Make1dIndex(h,w,3)] = value;
};
...
imageData.prototype.UpdateContext = function()
{
   this.context = this.canvasElement.getContext("2d");
};

imageData.prototype.DrawImgDataToCanvas = function()
{
   this.context.putImageData(this.imgDataObj, 0, 0);
};

imageData.prototype.UpdateImgDataObj = function()
{
   this.imgDataObj = this.context.getImageData(0,0,this.canvasElement.height,this.canvasElement.width);
};

imageData.prototype.Make1dIndex = function(h, w, c)
{
   return ((h * this.width * 4) + (w * 4) + c);
};
